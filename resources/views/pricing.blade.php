            ...
            <div class="bg-gray-50 py-16">
                <div class="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <!-- Free Plan -->
                        <div
                            class="bg-white border border-gray-200 rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                            ...
                            <a href="#"
                                class="block bg-blue-500 text-white text-center font-medium py-2 px-6 rounded-lg hover:bg-blue-600 transition">
                                Get Started
                            </a>
                        </div>
                        ...
                        <!-- Premium Plan -->
                        <div
                            class="bg-blue-50 border border-blue-500 rounded-lg shadow-lg p-6 hover:shadow-xl transition">
